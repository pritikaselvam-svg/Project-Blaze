...
The origin is defined as the **geometric centre of the wheelbase at ground level**.
...
$$
X_{\text{front}} = +775\text{ mm}
$$

$$
X_{\text{rear}} = -775\text{ mm}
$$
...
This coordinate system is used consistently for both architectures.
...
$$
Y_{CG}=\frac{\sum_i m_iY_i}{\sum_i m_i}
$$

$$
Z_{CG}=\frac{\sum_i m_iZ_i}{\sum_i m_i}
$$
...
Therefore, the CG lies approximately **84.5 mm behind the geometric centre of the wheelbase**.
...
$$
\boxed{Z_{CG,B}\approx240.5\text{ mm}}
$$
...
This occurs because Architecture C introduces substantial mass at the front of the vehicle.
...
$$
\boxed{Z_{CG,C}\approx237.0\text{ mm}}
$$
